# ============================================================================
# Basecamp Installer for Windows
# ============================================================================
...
$RepoUrlSsh = "git@github.com:33labs-xyz/hermes-agent-basecamp.git"
$RepoUrlHttps = "https://github.com/33labs-xyz/hermes-agent-basecamp.git"
$PythonVersion = "3.11"
$NodeVersion = "22"
...
function Write-Banner {
    ...
    Write-Host "|             * Basecamp Installer                        |" -ForegroundColor Magenta
    Write-Host "+---------------------------------------------------------+" -ForegroundColor Magenta
    Write-Host "|  Basecamp desktop agent.                                |" -ForegroundColor Magenta
    Write-Host "+---------------------------------------------------------+" -ForegroundColor Magenta
    Write-Host ""
}
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/33labs-xyz/hermes-agent-basecamp/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/33labs-xyz/hermes-agent-basecamp/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/33labs-xyz/hermes-agent-basecamp/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
