...
// ── icons ─────────────────────────────────────────────────────────────────────
const CheckSvg = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#8b80e8" strokeWidth="4">
  ...
  return (
    ...
    >
          ...
          <div className="w-full pt-6 flex justify-center animate-fade-in-up">
            <div className="flex flex-col items-center gap-4 py-16">
              <div className="relative w-20 h-20">
                ...
                <div className="absolute inset-2 rounded-full border-2 border-[#8b80e8]/30 animate-spin" />
        ...
        {!generating && history.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full pt-4 animate-fade-in-up">
            {history.map((entry, idx) => (
              <div
                key={entry.id || idx}
                className="relative group rounded overflow-hidden border border-white/10 bg-[#0d0d28] shadow-xl hover:border-primary/50 transition-all duration-300 flex flex-col"
              >
                {/* Video thumbnail */}
                <video
                  src={entry.url}
                ...
                <div className={`absolute top-2 left-2 px-2 py-0.5 rounded-md text-[9px] font-bold uppercase tracking-wider backdrop-blur-sm border ${
                  entry.mode === "edit"
                    ? "bg-[#8b80e8]/20 text-[#8b80e8] border-[#8b80e8]/30"
                ...
                <div className="absolute top-2 right-2 flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  ...
                  {entry.requestId && entry.canEdit !== false ? (
                    <button
                      ...
                      className="p-2 bg-black/60 backdrop-blur-md rounded-full text-white hover:bg-[#8b80e8] hover:text-black transition-all border border-white/10"
                    >
      ...
      <div className="absolute bottom-4 w-full max-w-[95%] lg:max-w-4xl z-40 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
        <div className="w-full bg-[#0d0d28]/80 backdrop-blur-3xl rounded-md border border-white/10 p-4 flex flex-col gap-2 shadow-2xl">

          {/* ── Edit mode banner ── */}
          {editMode && (
            <div className="flex items-center gap-2 px-3 py-1.5 mx-0 bg-[#8b80e8]/5 border border-[#8b80e8]/10 rounded text-[10px] text-[#8b80e8]/80 font-medium tracking-tight">
              ...
              <button
                ...
                className="ml-auto text-[#8b80e8]/40 hover:text-[#8b80e8] transition-colors text-base leading-none"
              >×</button>
            </div>
          )}
            ...
            <div className="flex items-center gap-1 bg-white/[0.03] border border-white/[0.05] rounded-full p-0.5 flex-shrink-0">
              <button
                ...
                className={`px-2.5 py-1 rounded-full text-[10px] font-semibold transition-all ${
                  !editMode ? "bg-[#8b80e8] text-black shadow" : "text-white/40 hover:text-white/70"
                }`}
              >
                Generate
              </button>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 pt-2 border-t border-white/[0.03] relative">
            <div className="flex items-center gap-2 relative flex-wrap pb-1 md:pb-0">
              ...
              <div className="relative">
                ...
                >
                  <div className="w-4 h-4 bg-[#8b80e8] rounded flex items-center justify-center shadow-lg shadow-[#8b80e8]/10">
                    <span className="text-[9px] font-bold text-black uppercase">A</span>
                  </div>
                  <span className="text-[11px] font-semibold text-white/70 group-hover:text-[#8b80e8] transition-colors">
                    {aspectRatio}
                  </span>
                ...
                {openDropdown === "ar" && (
                  <div className="absolute bottom-[calc(100%+12px)] left-0 z-50 bg-[#0d0d28] rounded-lg p-3 shadow-2xl border border-white/[0.05] min-w-[140px]">
              ...
              <div className="relative">
                ...
                {openDropdown === "dur" && (
                  <div className="absolute bottom-[calc(100%+12px)] left-0 z-50 bg-[#0d0d28] rounded-md p-3 shadow-2xl border border-white/10 min-w-[140px] max-h-52 overflow-y-auto custom-scrollbar">
              ...
              {editMode && editSources.length > 0 && (
                <div className="relative">
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-2 bg-[#8b80e8]/[0.04] hover:bg-[#8b80e8]/[0.08] rounded-md transition-all border border-[#8b80e8]/[0.08] group whitespace-nowrap"
                  >
                    <div className="w-4 h-4 bg-[#8b80e8]/20 rounded flex items-center justify-center border border-[#8b80e8]/30">
                      <svg width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="#8b80e8" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/>
                        <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/>
                      </svg>
                    </div>
                    <span className="text-xs font-semibold text-[#8b80e8]/70 group-hover:text-[#8b80e8] transition-colors max-w-[120px] truncate">
                  ...
                  {openDropdown === "source" && (
                    <div className="absolute bottom-[calc(100%+12px)] left-0 z-50 w-64 bg-[#0d0d28] rounded-lg p-3 shadow-2xl border border-white/[0.05] max-h-64 overflow-y-auto custom-scrollbar">
