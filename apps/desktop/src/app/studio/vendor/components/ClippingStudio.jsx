...
// Inline SVG Icons
// ---------------------------------------------------------------------------
const ScissorsIcon = ({ className = "text-[#8b80e8]" }) => (
...
const CheckIcon = () => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#8b80e8" strokeWidth="3">
          ...
          <div className="space-y-6 pt-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full animate-fade-in-up">
              {history.map((entry, idx) => (
                <div
                  key={entry.id || idx}
                  className="relative group rounded-lg overflow-hidden border border-white/10 bg-[#0d0d28] shadow-xl hover:border-primary/50 transition-all duration-300 flex flex-col"
                >
                        ...
                        return (
                          <button
                            ...
                            className={`w-full p-4 border rounded-lg text-left transition-all hover:bg-zinc-900/60 flex flex-col gap-2 group/hl ${
                              isActive 
                                ? "border-primary bg-primary/5 shadow-[0_0_12px_rgba(139,128,232,0.03)]" 
          ...
          <div className="flex items-center gap-3 px-1">
            ...
            <button
              ...
              className={`w-10 h-10 shrink-0 rounded-full border transition-all flex items-center justify-center relative overflow-hidden ${
                videoUrl 
                  ? "border-[#8b80e8]/60 bg-[#8b80e8]/5" 
                  : "bg-white/5 border-white/[0.03] hover:bg-white/10 hover:border-[#8b80e8]/40"
              } group`}
            >
              {videoUploading ? (
                <div className="flex flex-col items-center justify-center w-full h-full absolute inset-0 bg-black/85 z-20 backdrop-blur-[1px]">
                  <svg className="w-8 h-8 -rotate-90">
                    ...
                    <circle
                      ...
                      className="text-[#8b80e8] transition-all duration-300"
                    />
                  </svg>
                  <span className="absolute text-[8px] font-black text-[#8b80e8] leading-none">
                    {videoProgress}%
                  </span>
                </div>
              ) : null}
              ...
              {videoUrl ? (
                <div className="w-full h-full flex items-center justify-center bg-[#8b80e8]/10 text-[#8b80e8]">
                ...
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-white/40 group-hover:text-[#8b80e8] transition-colors">
                  <polygon points="23 7 16 12 23 17 23 7" />
                  <rect x="1" y="5" width="15" height="14" rx="2" ry="2" />
                </svg>
              )}
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 pt-2 border-t border-white/[0.03] relative">
            <div className="flex items-center gap-2 relative flex-wrap pb-1 md:pb-0">
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                {aspectDropdownOpen && (
                  <div className="absolute bottom-[calc(100%+12px)] left-0 z-50 bg-[#0d0d28] rounded-lg p-3 shadow-2xl border border-white/[0.05] min-w-[160px]">
              ...
              <div className="relative" ref={highlightsDropdownRef}>
                ...
                {highlightsDropdownOpen && (
                  <div className="absolute bottom-[calc(100%+12px)] left-0 z-50 bg-[#0d0d28] rounded-md p-3 shadow-2xl border border-white/10 min-w-[180px]">
              ...
              <button
                ...
                className={`flex items-center gap-2 px-3 py-2 rounded-md transition-all border whitespace-nowrap text-[11px] font-semibold ${
                  returnCoordinatesOnly 
                    ? "bg-primary/10 border-primary/20 text-[#8b80e8]" 
            ...
            <button
              ...
              className="bg-[#8b80e8] text-black px-4 py-2 rounded-md font-medium text-sm hover:bg-[#b9a8ff] hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 w-full sm:w-auto shadow-lg shadow-[#8b80e8]/10 disabled:opacity-50 disabled:cursor-not-allowed uppercase tracking-wider"
            >
              {isGenerating ? (
                <>
