  ...
  return (
    <div className="flex flex-col items-center relative w-[130px] md:w-[150px] shrink-0 snap-center">
      ...
      <div className="relative overflow-hidden w-full h-[280px] md:h-[300px] bg-gradient-to-b from-white/[0.02] to-transparent rounded-2xl border border-white/[0.03] shadow-2xl backdrop-blur-3xl group">
        {/* Masks */}
        <div className="absolute top-0 left-0 right-0 h-24 bg-gradient-to-b from-[#0d0d28] to-transparent z-20 pointer-events-none" />
        <div className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-[#0d0d28] to-transparent z-20 pointer-events-none" />
...
function CameraControlsOverlay({
  ...
  return (
    <div
      ref={backdropRef}
      className={`fixed inset-0 bg-[#0d0d28]/80 backdrop-blur-2xl z-[100] flex items-center justify-center transition-all duration-500 ${isOpen ? "opacity-100" : "opacity-0 pointer-events-none"}`}
      onClick={handleBackdropClick}
    >
      <div
        className={`w-full max-w-5xl bg-[#0d0d28] border border-white/5 rounded-3xl p-6 md:p-10 shadow-[0_0_100px_rgba(0,0,0,0.8)] transform transition-all duration-500 flex flex-col max-h-[90vh] ${isOpen ? "scale-100 translate-y-0" : "scale-95 translate-y-10"}`}
      >
        {/* Header */}
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center bg-black relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full pt-4 animate-fade-in-up">
            {history.map((entry, idx) => (
              <div
                ...
                className="relative group rounded-lg overflow-hidden border border-white/10 bg-[#0d0d28] shadow-xl hover:border-[#8b80e8]/50 transition-all duration-300 flex flex-col cursor-pointer"
              ...
              >
                ...
                <div className="p-3 bg-black/80 backdrop-blur-sm border-t border-white/5 flex-1 flex flex-col justify-between gap-2">
                  ...
                  <div className="flex items-center justify-between mt-1 flex-wrap gap-1">
                    <span className="text-[10px] font-bold text-[#8b80e8] px-2 py-0.5 bg-[#8b80e8]/10 rounded border border-[#8b80e8]/20">
      ...
      <div className="absolute bottom-4 left-4 right-4 md:left-0 md:right-0 md:mx-auto md:max-w-[95%] lg:max-w-4xl z-30 transition-all duration-700 animate-fade-in-up">
        <div className="bg-[#0d0d28]/80 backdrop-blur-3xl border border-white/10 rounded-md p-4 flex justify-between shadow-2xl items-end relative gap-2">
          {/* Left Column */}
          <div className="flex-1 flex flex-col gap-3 min-h-[80px] justify-between py-1">
            ...
            <div className="flex justify-between gap-2">
              ...
              <div className="flex items-center gap-3 h-full self-end mb-1">
                ...
                >
                  <div className="absolute top-3 right-3 w-1.5 h-1.5 bg-[#8b80e8] rounded-full shadow-lg shadow-[#8b80e8]/20" />
                  ...
                  <span className="text-xs font-semibold text-white/70 truncate w-full group-hover:text-[#8b80e8] transition-colors">
                    {formatSummaryValue()}
                  </span>
                </button>
                ...
                {/* Generate Button */}
                <button
                  className="h-[50px] px-8 bg-[#8b80e8] text-black rounded-md font-medium text-sm hover:bg-[#b9a8ff] hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 shadow-lg shadow-[#8b80e8]/10 disabled:opacity-50 disabled:cursor-not-allowed"
