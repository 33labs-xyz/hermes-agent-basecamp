...
export class HermesGateway extends JsonRpcGatewayClient {
  constructor() {
    super({
      closedErrorMessage: 'Basecamp gateway connection closed',
      connectErrorMessage: 'Could not connect to Basecamp gateway',
      createRequestId: nextId => nextId,
      notConnectedErrorMessage: 'Basecamp gateway is not connected',
