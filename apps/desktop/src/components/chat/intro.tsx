...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should Basecamp look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} Basecamp need to see?`,
    ...
    {
      headline: `What should ${label} Basecamp tackle?`,
  ...
  return (
    ...
    >
      <div className="w-full min-w-0">
        <p
          aria-label={WORDMARK}
          className="fit-text mx-auto mb-1 w-[calc(100%-1rem)] font-['Poppins'] font-black uppercase leading-[0.9] tracking-[0.02em] text-midground mix-blend-plus-lighter dark:text-foreground/90"
