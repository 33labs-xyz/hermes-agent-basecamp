...
export const en: Translations = {
  ...
  boot: {
    ready: 'Basecamp Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Basecamp settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Basecamp Desktop…'
    },
    errors: {
      backgroundExited: 'Basecamp background process exited.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Basecamp backend is older than this desktop build and may not work correctly. Update to align them.',
    updateHermes: 'Update Basecamp',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Basecamp Desktop.',
    ...
    native: {
      ...
      inputBody: 'Basecamp is waiting for your response.',
      turnDoneTitle: 'Basecamp finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Basecamp defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Basecamp is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Basecamp asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Basecamp was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Basecamp follow your system setting.',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Basecamp checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Basecamp configuration...',
    ...
    gateway: {
      ...
      intro:
        'Basecamp Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Basecamp backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private Basecamp backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Basecamp backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'Basecamp Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Basecamp ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription - no API key to copy. Basecamp runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Basecamp desktop' },
    ...
    hermesActiveSessions: (version, count) => `Basecamp ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Basecamp environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Basecamp will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      instructionsPlaceholder: 'Custom instructions for every chat in this project',
      instructionsHint: 'These instructions are added to every chat in this project to steer the agent.',
      create: 'Create',
      ...
      assignDesc: 'Choose a project for this chat. Its instructions will steer the chat.',
      none: 'No project',
      assigned: 'Added to project',
      assignFailed: 'Could not add to project',
      removed: 'Removed from project',
      removeFailed: 'Could not remove from project',
      page: {
        openProject: 'Open project',
        back: 'Back to chat',
        newChat: 'New chat in this project',
        recentChats: 'Chats',
        recentJustNow: 'Just now',
        recentScheduled: 'Scheduled',
        noChats: 'No chats in this project yet',
        notFound: 'Project not found',
        instructionsTitle: 'Instructions',
        instructionsHint: 'Added to every chat in this project to steer the agent.',
        instructionsSaved: 'Instructions saved',
        instructionsSaveFailed: 'Could not save instructions',
        save: 'Save',
        saving: 'Saving…',
        knowledgeTitle: 'Project knowledge',
        knowledgeHint: 'Text and markdown shared with every chat in this project.',
        knowledgeEmpty: 'No knowledge files yet',
        knowledgeLoadFailed: 'Could not load knowledge files',
        addFile: 'Upload file',
        fileNameLabel: 'Name',
        fileNamePlaceholder: 'notes.md',
        pasteLabel: 'Or paste text',
        pastePlaceholder: 'Paste text to add as project knowledge…',
        addKnowledge: 'Add',
        knowledgeAdded: 'Knowledge added',
        knowledgeAddFailed: 'Could not add knowledge',
        knowledgeDeleted: 'Knowledge removed',
        ...
        composerPlaceholder: 'What would you like to work on in this project?',
        composerSend: 'Start chat',
        projectActions: 'Project options',
        scheduledTitle: 'Scheduled',
        scheduledEmpty: 'Set up recurring tasks for this project.',
        scheduledAdd: 'New scheduled task',
        scheduledCancel: 'Cancel',
        scheduledCreate: 'Schedule',
        scheduledCreated: 'Scheduled task created',
        scheduledCreateFailed: 'Could not create the scheduled task',
        scheduledLoadFailed: 'Could not load scheduled tasks',
        scheduledToggleFailed: 'Could not update the scheduled task',
        scheduledDeleted: 'Scheduled task removed',
        scheduledDelete: 'Delete task',
        scheduledDeleteFailed: 'Could not remove the scheduled task',
        scheduledActive: 'Active',
        scheduledPause: 'Pause',
        scheduledPaused: 'Paused',
        scheduledResume: 'Resume',
        scheduledNoCadence: 'No cadence set',
        scheduledPromptLabel: 'Task prompt',
        scheduledPromptPlaceholder: 'What should run on a schedule?',
        scheduledCadenceLabel: 'Cadence',
        scheduledCadencePlaceholder: 'e.g. every day at 9am',
        scheduledRepeatLabel: 'Repeat',
        scheduledRepeatOnce: 'Once',
        scheduledRepeatDaily: 'Daily',
        scheduledRepeatWeekly: 'Weekly',
        scheduledRepeatMonthly: 'Monthly',
        scheduledDateLabel: 'Date',
        scheduledTimeLabel: 'Time',
        scheduledWeekdayLabel: 'Day of week',
        scheduledMonthdayLabel: 'Day of month',
        contextTitle: 'Context',
        memoryTitle: 'Memory',
        memoryHint: 'Short facts the agent keeps in mind across every chat in this project.',
        memoryEmpty: 'Ask Basecamp to remember something and it\'ll save it here.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Basecamp...',
    placeholderReconnecting: 'Reconnecting to Basecamp…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give Basecamp a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'Basecamp will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of Basecamp can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Basecamp from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Basecamp will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody: 'The Basecamp updater will take over in its own window and reopen Basecamp when it’s done.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Basecamp reconnects automatically when it’s back.',
    applyingClose: 'Basecamp will close to apply the update.',
  ...
  install: {
    ...
    oneTimeTitle: 'Basecamp needs a one-time install',
    ...
    settingUpTitle: 'Setting up Basecamp Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Basecamp CLI or desktop instance is running. Stop any running Basecamp instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Basecamp installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Basecamp Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Basecamp is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Basecamp…',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Basecamp at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser - Basecamp connects automatically',
      loopback: 'Opens your browser to sign in - Basecamp connects automatically',
    ...
    authorizeThere: 'Authorize Basecamp there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Basecamp there and you'll be connected automatically - nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Basecamp inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Basecamp will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Basecamp is restarting...',
      askRestart: 'Ask Basecamp to restart the server',
      lookingRestart: taskId => `Basecamp is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Basecamp is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Basecamp finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Basecamp could not restart the server.',
      stillWorking:
        'Basecamp is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Basecamp is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'Basecamp gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.basecamp/config.yaml). Basecamp won’t ask again for commands like this - in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Basecamp needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Basecamp needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Basecamp Desktop to use Save Image.',
    restartToSaveImages: 'Restart Basecamp Desktop to save images',
