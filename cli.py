...
# ASCII Art - BASECAMP logo (full width, single line - requires ~95 char terminal)
...
# Padded with braille blank U+2800 (not spaces) so center-justify can't
# rstrip lines and drift them: every line is exactly 18 cells.
HERMES_CADUCEUS = """\
[#b6abdf]⠀⠀⠀⠀⠀⠀⠀⠀⣼⣧⠀⠀⠀⠀⠀⠀⠀⠀[/]
[#b6abdf]⠀⠀⠀⠀⠀⠀⠀⣼⣿⣿⣧⠀⠀⠀⠀⠀⠀⠀[/]
[#b6abdf]⠀⠀⠀⠀⠀⠀⣼⣿⣿⣿⣿⣧⠀⠀⠀⠀⠀⠀[/]
